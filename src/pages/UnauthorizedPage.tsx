export default function UnauthorizedPage() {
  const imageUrl = "/src/assets/UNAUTHORIZED.jpg";
    ...
    >
      ...
      <div className="relative z-10 p-6 md:p-12 lg:p-24 max-w-2xl mx-auto md:mx-0">
        ...
        <h2 className="text-2xl md:text-3xl lg:text-4xl font-semibold leading-tight mb-6">
          Red Card! Unauthorized Access.
        </h2>
        <p className="text-base md:text-lg text-gray-200 mb-8">
          Looks like you're trying to enter an area without the proper
          credentials. The referee has given you a red card, and you'll have to
          sit this one out.
        </p>
        <a
          href="/"
